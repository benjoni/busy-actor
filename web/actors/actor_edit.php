...
$sql3="select * from $myactors where id=$id";
...
$mail=$data['email'];
$phone=$data['phone'];
switch ($_SESSION['a3'] ){case "": $a3="hidden";break;default: $a3="";break;}
?>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <!-- users edit account form start -->
                                        ...
                                        <form action="actor_update_sql.php" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" name="actor_name" class="form-control" value="<?php echo $name ?> "  required>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label>Role</label>
                                                        <input type="text" name="actor_role" class="form-control" value="<?php echo $role ?> " required>
                                                    </div>
                                                </div>
                                                <div class="  form-group">
                                                    <div class="hidden controls">
                                                        <label>ID</label>
                                                        <input type="text" name="actor_id" class="form-control" value= <?php echo $id ?> required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label>E-mail</label>
                                                        <input type="email" name="actor_email" class="form-control" value="<?php echo $mail ?>" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label>Phone</label>
                                                        <input type="tel" name="actor_phone" class="form-control" value="<?php echo $phone ?>" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                                <button type="submit" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">Save
                                                    Changes</button>
                                                <a href="<?php echo $a3 ?> actor_delete_sql.php?id=<?php echo $id?>" class="<?php echo $a3 ?> btn btn-outline-danger d-none d-sm-block" >Remove</a>
