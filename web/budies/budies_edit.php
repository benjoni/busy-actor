                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form action="budies_update_sql.php" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" name="budy_name" class="form-control" value="<?php echo $name ?> " required>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label>E-mail</label>
                                                        <input type="email" name="budy_email" class="form-control"value="<?php echo $mail ?> " required>
                                                    </div>
                                                </div>
                                                <div class="  form-group">
                                                    <div class="hidden controls">
                                                        <label>ID</label>
                                                        <input type="text" name="user_id" class="form-control" value= <?php echo $id ?> required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class=" table-responsive border rounded px-1 ">
                                                    ...
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tr>
                                                            <td>Herci</td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox1" name="A1" class="custom-control-input" <?php  switch ($a1){case 1:echo "checked";break;} ?>>
                                                                    <label class="custom-control-label" for="users-checkbox1"></label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox2" name="A2" class="custom-control-input"  <?php  switch ($a2){case 1:echo "checked";break;} ?>>
                                                                    <label class="custom-control-label" for="users-checkbox2"></label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox3" name="A3" class="custom-control-input" <?php   switch ($a3){case 1:echo "checked";break;} ?>>
                                                        ...
                                                        <tr>
                                                            <td>Obrazy</td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox5" name="B1"  class="custom-control-input" <?php  switch ($b1){case 1:echo "checked";break;} ?>>
                                                                    <label class="custom-control-label" for="users-checkbox5"></label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox6" name="B2" class="custom-control-input" <?php  switch ($b2){case 1:echo "checked";break;}?> >
                                                                    <label class="custom-control-label" for="users-checkbox6"></label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox7" name="B3" class="custom-control-input" <?php  switch ($b3){case 1:echo "checked";break;} ?>>
                                                        ...
                                                        <tr>
                                                            <td>Zaneprázdnenosť</td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox9" name="C1" class="custom-control-input" <?php  switch ($c1){case 1:echo "checked";break;} ?>>
                                                                    <label class="custom-control-label" for="users-checkbox9"></label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox10" name="C2" class="custom-control-input" <?php  switch ($c2){case 1:echo "checked";break;} ?>disabled>
                                                                    <label class="custom-control-label" for="users-checkbox10"></label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox11" name="C3" class="custom-control-input" <?php  switch ($c3){case 1:echo "checked";break;} ?>disabled>
                                                        ...
                                                        <tr>
                                                            <td>Výpočet</td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox12" name="D1" class="custom-control-input" <?php  switch ($d1){case 1:echo "checked";break;}?>>
                                                                    <label class="custom-control-label" for="users-checkbox12"></label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox13" name="D2" class="custom-control-input" <?php  switch ($d2){case 1:echo "checked";break;}?>disabled>
                                                                    <label class="custom-control-label" for="users-checkbox13"></label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox"><input type="checkbox" id="users-checkbox14" name="D3" class="custom-control-input" <?php  switch ($d3){case 1:echo "checked";break;} ?>disabled>
                                            ...
                                            <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                                ...
                                                <a href="budies_delete_sql.php?id=<?php echo $id?>" class="btn btn-outline-danger d-none d-sm-block" >Remove</a>
