...
switch ($_SESSION['b2'] ){case "": $b2="hidden";break;default: $b2="";break;}
?>
            ...
            <div class="content-header-left col-md-9 col-12 mb-0">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="dropdown">
                            <button class="<?php echo $b2 ?>btn btn-light dropdown-toggle mr-1" type="button" id="dropdownMenuButton6" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Action
                            </button>
            ...
            <section id="data-thumb-view" class="data-thumb-view-header">
                ...
                <div class="table-responsive">
                   ...
                   // include ("pomocne/connection.php");
                    $sql="select * from $myscene order by scene";
                        ...
                        while ($row=mysqli_fetch_assoc($run))
                        {
                            ...
                            <tr>
                                ...
                                <td class="product-action">
                                    ...
                                    <a href="scenes/scene_edit.php?id=<?php echo $id=$row['id']?>" class="<?php echo $b2 ?>feather icon-edit"></a>
