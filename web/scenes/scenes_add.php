                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                ...
                                <li class=" nav-item">
                                    <a class="hidden nav-link d-flex align-items-center" id="information-tab" data-toggle="tab" href="#information" aria-controls="information" role="tab" aria-selected="false">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form action="scenes_add_sql.php" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-3 ">
                                                ...
                                                <div class=" form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" name="scene" class="form-control" placeholder="scene number "  >
                                            ...
                                            <div class="col-5 ">
                                                <div class=" form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" name="synopsis" class="form-control" placeholder="something about scene" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class=" form-group">
                                                    <div class="controls">
                                                        <label>Set</label>
                                                        <input type="text" name="filmset" class="form-control" placeholder="set">
                                                    </div>
                                                </div>
                                                <div class=" form-group">
                                                    <div class="controls">
                                            ...
                                            <div class="col-4 ">
                                                ...
                                                <div class=" form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" name="scriptday" class="form-control"  >
                                                    </div>
                                                </div>
                                                <div class=" form-group">
                                                ...
                                                <div class="col-12 ">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Notes</label>
                                                            <input type="text" name="notes" class="form-control" placeholder="everything" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
