    ...
    <div class="col-lg-2 medzera">
      ...
      <strong>Select Actor</strong>
        <select name="select_user" id="select_user" class="form-control" onchange="open_events();">
            ...
            <?php
                $users_list_arr = $con->query("SELECT `id`, `role` FROM `$myactors` ;");
                if(mysqli_num_rows($users_list_arr)){
                    foreach($users_list_arr as $user){
                        echo '<option value='.$user['id'].'>'.$user['id'].". ".$user['role'].'</option>';
                    };
                };
            ?>
        </select>
        ...
        <form action="" method="POST">
          <select name="select_user_filter[]" id="select_user_filter" class="form-control" multiple>
              <?php
                  ...
                  if(mysqli_num_rows($users_list_arr)){
                      foreach($users_list_arr as $user){
                          echo '<option selected value='.$user['id'].'>'.$user['id'].". ".$user['role'].'</option>';
                      };
                  };
              ?>
          </select>
          <button type="submit" class="btn btn-info btn-sm btn-block">Choose</button>
        </form>
        <div>
            <a href="vypocet.php" class="btn btn-outline-primary  btn-inline">Back</a>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="app/ajaxquery.php">
        ...
        <input type="hidden" name="status" id="only_status2">
          ...
          <div class="form-group row">
            ...
            <div class="col-6">
              ...
              <input name="event_dokedy1" class="form-control time_select" type="text" placeholder="23:59" readonly="" aria-haspopup="true" aria-expanded="true" aria-readonly="false">
            </div>
          </div>
          <div class="form-group row">
            <div class="col-6">
            ...
            <div class="col-6">
              ...
              <input name="event_dokedy2" class="form-control time_select" type="text" placeholder="23:59" readonly="" aria-haspopup="true" aria-expanded="true" aria-readonly="false">
            </div>
          </div>
      </div>
          <div class="modal-footer">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="modal-footer">
            <form action="app/ajaxquery.php" method="POST">
